...
import 'package:resumeflow/services/client_gen_ai/client_cover_letter_gen_service/client_cover_letter_gen_servie.dart';
...
class ClientGenAi implements GenAiServiceInterface {
  ...
  Future<CoverLetterGenData> genCoverLetter(
      ...
      ClientCoverLetterGenServie(model).genData(coverLetter);
}
